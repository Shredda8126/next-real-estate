              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white/10 border border-gray-600 rounded-lg px-4 py-2 focus:border-[#ffa509] focus:ring-[#ffa509] text-gray-500 placeholder-gray-400"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleFilterChange}
                    className="w-full text-gray-500 bg-white/10 border border-gray-600 rounded-lg px-4 py-2 focus:border-[#ffa509] focus:ring-[#ffa509]"
                  >
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-4">
                    <select
                      ...
                      onChange={handleFilterChange}
                      className="flex-1 text-black bg-white/10 border border-gray-600 rounded-lg px-4 py-2 focus:border-[#ffa509] focus:ring-[#ffa509] text-gray-500"
                    >
