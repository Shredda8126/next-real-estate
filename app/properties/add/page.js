...
import { formatCurrency, parseCurrency } from '@/lib/currencyFormat';
...
export default function AddProperty() {
  ...
  const uploadImages = async () => {
    try {
      ...
      if (failedUploads.length > 0) {
        ...
        // Optionally throw an error if too many uploads fail
  ...
  const sampleProperties = {
    luxury: {
      title: 'Luxurious Clifton Beach Villa',
      description: 'Stunning seafront property in the prestigious Clifton area of Cape Town. This modern villa offers breathtaking ocean views, high-end finishes, and direct beach access. Perfect for those seeking a luxurious lifestyle in one of South Africa\'s most sought-after locations.',
      price: 45000000, // R45 million
      ...
      images: ['https://placehold.co/800x600/e2e8f0/1e293b.png?text=Clifton+Villa'],
      status: 'For Sale',
      address: {
        street: '15 Nettleton Road',
        city: 'Cape Town',
        state: 'Western Cape',
        zipCode: '8005',
    ...
    apartment: {
      title: 'Modern Sandton Central Apartment',
      description: 'Stylish urban apartment in the heart of Sandton, Johannesburg\'s premier business and lifestyle district. Features contemporary amenities, open-concept living space, and spectacular city views. Walking distance to top restaurants, shopping centers, and business hubs.',
      price: 3750000, // R3.75 million
      ...
      images: ['https://placehold.co/800x600/e2e8f0/1e293b.png?text=Sandton+Apartment'],
      status: 'For Sale',
      address: {
        street: '5 Maude Street',
        city: 'Sandton',
        state: 'Gauteng',
        zipCode: '2196',
        country: 'South Africa',
    ...
    suburban: {
      ...
      description: 'Beautiful family home located in a secure, gated community in Pretoria East. Spacious layout, modern finishes, and excellent security features. Perfect for families looking for a safe and comfortable living environment.',
      price: 2850000, // R2.85 million
      ...
      images: ['https://placehold.co/800x600/e2e8f0/1e293b.png?text=Pretoria+Family+Home'],
      status: 'For Sale',
      address: {
        street: '42 Silver Lakes Drive',
        city: 'Pretoria',
        state: 'Gauteng',
        zipCode: '0054',
        country: 'South Africa',
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#050b2c] to-[#0a1854] py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-wrap gap-4 mb-8">
          ...
          <button
            type="button"
            onClick={() => fillSampleData('suburban')}
            className="px-6 py-3 bg-[#ffa509] text-[#050b2c] rounded-xl hover:bg-[#ff9100] transition-all duration-300 font-bold flex items-center gap-2"
          >
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8">
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <div>
                ...
                />
                <p className="text-gray-300 text-sm">Price will be displayed as {formatCurrency(formData.price || 0)}</p>
              </div>
            </div>
          </div>
