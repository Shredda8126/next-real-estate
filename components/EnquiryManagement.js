                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-6">
                      <div className="space-y-3">
                        <p className="text-gray-300 flex items-center">
                          ...
                          <span className="ml-2">
                            {activeTab === "received" ? enquiry.sender?.name : enquiry.recipient?.name}
                          </span>
                        </p>
                        <p className="text-gray-300 flex items-center">
                          <MdEmail className="mr-2 text-[#ffa509]" />
                          <span className="font-semibold">
                            {activeTab === "received" ? "Sender's" : "Recipient's"} Email:
                          </span>
                          <span className="ml-2">
                            {activeTab === "received" ? enquiry.sender?.email : enquiry.recipient?.email}
                          </span>
                        </p>
                      </div>
                      <div className="space-y-3">
